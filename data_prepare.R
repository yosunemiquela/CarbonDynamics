...
AllPlots$Dep <- ifelse(AllPlots$Deposito=="1A" | AllPlots$Deposito=="1",
                ...
                ifelse(AllPlots$Deposito=="2",
                       "2_Fluvio_glaciar",
                ifelse(AllPlots$Deposito=="3",
                       "3_Fluvial",
                ifelse( AllPlots$Deposito=="4",
                       "4_Lacustre",
                ifelse(AllPlots$Deposito=="5",
                       "5_Marins",
                ifelse(AllPlots$Deposito=="6",
                       "6_Littoraux_marins",
                ifelse(AllPlots$Deposito=="7",
                       "7_Organique",
                ifelse(AllPlots$Deposito=="8",
                       "8_Depots_pentes",
                ifelse(AllPlots$Deposito=="R" | AllPlots$Deposito=="R1A",
                       "Rocheux",
                       "Other"))))))))))
...
#################################################
AllPlots$Drenaje <- ifelse(AllPlots$CL_DRAI=="0" | AllPlots$CL_DRAI=="1",
                           "1_DRY",
                    ifelse(AllPlots$CL_DRAI=="2",
                           "2_Bon",
                    ifelse(AllPlots$CL_DRAI=="3",
                           "3_Modere",
                    ifelse(AllPlots$CL_DRAI=="4",
                           "4_Imperfait",
                    ifelse(AllPlots$CL_DRAI=="5" | AllPlots$CL_DRAI=="6" ,
                           "5_WET",
                           "Other")))))
...
##########################################
subsetPlot <- subset(AllPlots, (Drenaje =="2_Bon" |
                                Drenaje=="3_Modere" |
                                Drenaje=="4_Imperfait") & (Dep=="1_Till.Thin" | Dep=="1_Till.Thick" | Dep== "2_Fluvio_glaciar"),
                     select = c(1:length(AllPlots)))
...
names(Intensities)[c(2, 3, 4, 5, 6, 7, 8, 12)] <- c("Annee", "JA", "Comb", "iLat",
                                                    "iLon", "INT", "Domaine", "Numero")
